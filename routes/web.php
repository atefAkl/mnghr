...
Route::group(
    ...
    function () {
      ...
      ======================================================================================================================================== */
<<<<<<< HEAD
      Route::get('/receipts/input/home',                      [InputReceiptsController::class, 'home'])->name('display-inputReceipts-list');
      Route::get('/receipts/receipts/index',                  [InputReceiptsController::class, 'index'])->name('display-receipts-list');
...
=======
        ...
        Route::post('/receipts/store',                          [InputReceiptsController::class, 'store'])->name('save-receipt-info');
        Route::get('receipts/destroy/{id}',                     [InputReceiptsController::class, 'destroy'])->name('destroy-receipt-info');
>>>>>>> d82be1142ea0a737956769cba8316a1a8ea0cfe6

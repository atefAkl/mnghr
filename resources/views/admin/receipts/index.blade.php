        ...
        <div class="col col-12">
            <fieldset class="mt-4 mx-0 mb-0">
                ...
                <div class="input-group">
                    <button class="py-0 ms-4 btn btn-outline-primary" data-type="{{ $direction_input }}"><a
                        ...
                        <tbody>
                            ...
                            @if (count($receipts))
                                @foreach ($receipts as $receipt)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><a class="btn btn-sm py-0 p-0" data-bs-toggle="tooltip"
                                                title="Q-Display Receipt" href="">{{ $receipt->serial }}</a></td>
                                        <td data-bs-toggle="tooltip" title=" {{ $receipt->serial }}">
                                            {{ @$reference_type[$receipt->reference_type] }}</td>
                                        ...
                                        <td>
                                            ...
                                            @if ($receipt->status === 1)
                                                ...
                                                @endphp
                                                <a class="btn btn-sm py-0 p-0" data-bs-toggle="tooltip"
                                                    title="Add Entries" href="{{ route($addEntry, [$receipt->id]) }}"><i
                                            ...
                                            <a class="btn btn-sm py-0 p-0" data-bs-toggle="tooltip"
                                                title="Q-Display Receipt" href=""><i

...
<li class="breadcrumb-item"><a href="/admin/stores/home">Receipts Output</a></li>
<li class="breadcrumb-item active" aria-current="page">Home</li>
@endsection
@section('contents')

<h1 class="mt-3 pb-2" style="border-bottom: 2px solid #dedede">All output Receipts
  <a class=" ms-1" data-bs-toggle="collapse" data-bs-target="#addreceiptForm" aria-expanded="false"
    aria-controls="addreceiptForm"><i data-bs-toggle="tooltip" title="Add New Receipt"
...
<div class="row">
  <div class="col col-12">
    ...
    <div class="">
        <a href="/admin/receipts/output/inProgressReceipts" class="nav-link" id="linkInProgress">
            <legend style="background-color:#19A7CE; color:#fff;" class="active">InProgress Receipts &nbsp; &nbsp;</legend>
        </a>
        <a href="/admin/receipts/output/approvedReceipts" class="nav-link" id="linkApproved">
            <legend style="left: 15.5rem;background-color:#9DB2BF;color:#000;">Approved Receipts &nbsp; &nbsp;</legend>
        </a>
        <a href="/admin/receipts/output/archivedReceipts" class="nav-link" id="linkArchived">
            <legend style="left: 28.4rem;background-color:#9DB2BF;color:#000;">Archived Receipts &nbsp; &nbsp;</legend>
        </a>
    </div>
      ...
      <div class="row d-flex justify-content-end mt-2">
        <form class="col col-9">
          ...
          <div class="input-group sm mb-2">
            ...
            <input type="text" class="form-control sm " name="serial" id="serial" placeholder="Serial Number">

            <input type="number" class="form-control sm" name="reference_type" id="reference_type" placeholder="Reference Type">
            <select class="form-select" name="admin_id" id="admin_id">
            ...
            <input type="number" class="form-control sm" name="reception_date" id="reception_date" placeholder="Before Date">

            <button type="submit" class="form-control btn btn-info ">Apply Filter
            </button>
          </div>
        </form>
      </div>

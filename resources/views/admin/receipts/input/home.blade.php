...
<div class="row">
  <div class="col col-12">
    <fieldset class="mt-4 mx-0 mb-0">
      <div class="d-flex ">
        <a href="/admin/receipts/input/inProgressReceipts">
          <legend style="background-color:#19A7CE;;color:#fff;"> InProgress Receipts &nbsp; &nbsp;

          </legend>
        </a>
        <a href="/admin/receipts/input/approvedReceipts">
          <legend style="left: 15.5rem;background-color:#9DB2BF;color:#000;"> Approved Receipts &nbsp; &nbsp;

          </legend>
        </a>
        <a href="/admin/receipts/input/archivedReceipts">
          <legend style="left: 28.4rem;background-color:#9DB2BF;color:#000;"> Archived Receipts &nbsp; &nbsp;

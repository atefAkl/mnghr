...
@section('contents')
    ...
    <div class="d-flex">
        <div>Form Of create Product</div>
            ...
            <div class="card card-body ">
                ...
                <form id="categoryForm" action="/admin/items/categories/store" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="cat_name" class="form-control @error('cat_name') is-invalid @enderror"
                            name="cat_name" value="{{ old('cat_name') }}" data-toggle="tooltip" data-placement="top"
                            title="@error('cat_name'){{ $message }}@enderror">
                    </div>

                    <div class="input-group  mt-2">
                        <label class="input-group-text" for="cat_brief">Description</label>
                        <input type="text" id="cat_brief" class="form-control @error('cat_brief') is-invalid @enderror"
                            name="cat_brief" value="{{ old('cat_brief') }}" data-toggle="tooltip" data-placement="top"
                            title="@error('cat_brief'){{ $message }}@enderror">
                    </div>
                ...
                <form action="{{ route('store-new-product') }}" method="POST" accept="[]" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('barcode') is-invalid @enderror" name="barcode"
                            value="{{ old('barcode') }}" autofocus data-toggle="tooltip" data-placement="top"
                            title="@error('barcode'){{ $message }}@enderror">
                    ...
                    <div class="input-group  mt-2">
                        ...
                        <input type="text" id="name" placeholder="Product Name"
                            ...
                            value="{{ old('name') }}" data-toggle="tooltip" data-placement="top"
                    ...
                    <div class="input-group  mt-2">
                        ...
                        <input type="text" id="breif" class="form-control @error('breif') is-invalid @enderror"
                            name="breif" value="{{ old('breif') }}" data-toggle="tooltip" data-placement="top"
                            title="@error('breif'){{ $message }}@enderror">
                    </div>
                    <div class="input-group mt-2">
        ...
        $(document).ready(function() {
            @if ($errors->any()) // لو حصل لدينا اي ايرر
                @if ($errors->has('cat_name') || $errors->has('cat_brief')) // input cat_name or input cat_brief  لو الايرر موجود في 
                    $('#addItemCategoryForm').collapse(
                        'show'); //   مفتوحaddItemCategoryForm الذي لديه collapse خليلى
                @else
                    ($errors - > has('name') || $errors - > has('breif') || $errors - > has(
                        'barcode')) //   item بتاع input name or input brief or input barcode   لو الايرر موجود في 

  ...
  <div class="card card-body">
      <form action="/admin/items/categories/store" method="POST">
        ...
        <div class="input-group">
          ...
          <input type="text"  id="cat_name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"   data-toggle="tooltip" data-placement="top" title="@error('name'){{ $message }}@enderror" >
        </div>

        <div class="input-group  mt-2">
          <label class="input-group-text" for="brief">Description</label>
          <input type="text"   id="brief"  class="form-control @error('breif') is-invalid @enderror" name="breif" value="{{ old('breif') }}"    data-toggle="tooltip" data-placement="top" title="@error('breif'){{ $message }}@enderror">
        </div>

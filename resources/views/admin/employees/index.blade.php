...
<div class="card-body my-4">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card h-100 rounded employee-card">
                <a href="{{ route('display-employee-info', $employee->id) }}" class="text-decoration-none text-dark">
                    <div class="px-2 py-3">
                    <div class="" 
                        style="
                        margin: auto;
                        ...
                        border-radius: 50%;
                        width: 50px; 
                        background: url('{{ asset($employee->profilePicture()) }}');
                    ...
                    <div class="col-auto text-center">
                        ...
                        <p class="card-text text-muted">{{ $employee->jobtitle->title }}</p>
                    </div>
                </div>
                </a>
            </div>
        ...
        <div class="col-12">
            ...
            <div class="card h-100 rounded employee-card">
                <div class="card-body text-center">
                    <p class="card-text text-muted">لم يتم بعد تسجيل أى موظف حتى الآن، بادر بـ   
        ...
        <div class="col-md-3">
            <div class="card h-100 rounded employee-card">
                <a data-bs-toggle="modal" data-bs-target="#createModal" class="d-block text-center">
                    <span class="d-block text-center" data-bs-toggle="tooltip" data-bs-placement="top" 
                    style="font-size: 2rem; line-height: 100%;" title="{{ __('employees.create-new-employee') }}">
                       +
                    </span>
                </a>
            </div>
